...
% ============== TITLE ==============
\title{\textbf{Planck's Field I: The Observable Universe as a Condensate}\\[0.5em]
...
The frozen core dark matter interpretation resolves the previously identified Lyman-alpha mass tension. The remaining open problems are the frozen core mass spectrum $N(M)$ (requiring numerical simulation of condensation dynamics) and the quantitative resolution of $H_0$ and $S_8$ tensions (requiring MCMC analysis with modified Boltzmann codes).
